        ...
        public async Task<Gokhan.Core.Services.PaginatedList<VoucherExpensesEntity>> getVouchers(VoucherPostRequestModel model)
        {
            ...
            IQueryable<VoucherExpensesEntity> result =    from    table in voucherQueryable
                            ...
                            select( new VoucherExpensesEntity() { voucherNo = table.voucherNo, rowNo = table.rowNo, rowDate = table.rowDate,
                                         ...
                                         voucherStatus = (int)(table.voucherStatus),voucherType = table.voucherType,accountNo = table.accountNo,
                                         ...
                                         InvoiceNoList = context.P300INVOICE_INVOICE_NO((int)table.voucherStatus),
